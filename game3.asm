...
TAGLINE DB  'Developed by Bhavesh Goyal$' ; DEVELOPER NAME 
...
CP1 DB 'Do you want to play single player or multiplayer.$'
CP2 DB 'Choose 1 for single player 2 for multiplayer.$'
VA DB '1$' 
...
; ---------- CHHOSE PLAYER MODE END ---------
    ...
    ; CHECKING IF INPUT IS BETWEEN 1-2
    CMP BL, 1
    JZ  CPL1 
